...
class ProductFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            'name' => array("ar"=>fake()->name(),"en"=>fake()->name()),
            'description' =>array("ar"=>'وصف المنتج',"en"=>'product description'),
            'category_id' => 1,
            'price' => '100',
            'additional_info' => array("ar"=>'معلومات اضافية',"en"=>'additional_info'),
            'image' => json_encode(array($randomImages[rand(0,10)])),
