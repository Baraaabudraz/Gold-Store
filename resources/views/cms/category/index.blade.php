...
@section('title')
    {{trans('dashboard_trans.Categories')}}
@endsection
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Categories')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('categories.index')}}" class="text-muted text-hover-primary">{{trans('dashboard_trans.Categories')}}</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{trans('dashboard_trans.All categories')}}</span>
            </h3>
            ...
            <div class="card-toolbar">
                ...
                <a href="{{route('categories.create')}}" class="btn btn-sm btn-light-primary">
                    ...
                    <!--end::Svg Icon-->  {{trans('dashboard_trans.Add new category')}}</a>
                @endif
            </div>
                ...
                <table class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                    ...
                    @foreach($categories as $key=>$category)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-30px me-5">
                                        <img src="{{url('/category/'.$category->image)}}" class="" alt="">
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>{{$category->name}}</td>
                            <td>
                                @if(isset(Auth()->user()->role->permission['name']['category']['can-edit']))
                                <a href="{{route('categories.edit' , $category->id)}}" class="btn btn-sm btn-light-primary">
                                    <!--begin::Svg Icon | path: icons/duotone/Communication/Add-user.svg-->
                                ...
                                @endif
                                    @if(isset(Auth()->user()->role->permission['name']['category']['can-delete']))
