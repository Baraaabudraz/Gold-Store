...
@section('title')
    {{trans('dashboard_trans.Edit industrial sector')}}
@endsection
@section('content')
    <!--begin::Toolbar-->
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Edit industrial sector')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <a href="#" class="text-muted text-hover-primary">{{trans('dashboard_trans.Industrial Sectors')}}</a>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.Edit industrial sector')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{trans('dashboard_trans.Edit industrial sector')}}</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="text-gray-400 fw-bold fs-5">{{trans('dashboard_trans.You can browse the list of industrial sectors')}}
                        ...
                        <div class="row">
                            @foreach(config('lang') as $key => $lang)
                                <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="text" value="{{$categories->getTranslation('name',$key)}}" name="name[{{$key}}]" class="form-control @error('name.*') is-invalid @enderror " id="" aria-describedby="" placeholder="{{trans('dashboard_trans.Enter Name Of')}} {{trans('dashboard_trans.Industrial Sector')}}">
                                    @error('name.*'.$key)
                            ...
                            @endforeach
                                @foreach(config('lang') as $key => $lang)
                                    <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                        ...
                                        <textarea name="description[{{$key}}]" class="form-control @error('description.*') is-invalid @enderror">{{$categories->getTranslation('description',$key)}}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="image-input image-input-outline"  data-kt-image-input="true"
                                        ...
                                        <div class="image-input-wrapper w-400px h-300px"
                                             style="background-image: url({{url('category/',$categories->image)}});object-fit: cover"></div>
