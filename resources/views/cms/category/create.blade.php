...
@section('title')
    {{trans('dashboard_trans.Add new category')}}
@endsection
@section('content')
    <!--begin::Toolbar-->
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Add new category')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <a href="#" class="text-muted text-hover-primary">{{trans('dashboard_trans.Categories')}}</a>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.Add new category')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{trans('dashboard_trans.Add new category')}}</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="text-gray-400 fw-bold fs-5">{{trans('dashboard_trans.You can browse the list of categories')}}
                            <a href="{{route('categories.index')}}" class="fw-bolder link-primary">{{trans('dashboard_trans.here')}}</a>.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->

                    <form method="POST" action="{{route('categories.store')}}" enctype="multipart/form-data" class="w-100 position-relative mb-3">
                        @csrf
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="{{trans('dashboard_trans.Enter the name of the category')}}"></i>
                                        </label>
                                        <input class="form-control form-control-solid" name="name[{{$key}}]" placeholder="{{trans('dashboard_trans.Enter Name Of')}} {{trans('dashboard_trans.Category')}} " value="{{old('name.'.$key)}}" />
                                        @error('name.*'.$key)
                                    ...
                                    <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <textarea name="description[{{$key}}]" class="form-control @error('description') is-invalid @enderror "></textarea>
