...
@section('title')
    {{trans('dashboard_trans.All subcategories')}}
@endsection
@section('content')
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.All subcategories')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <a href="#" class="text-muted text-hover-primary">{{trans('dashboard_trans.All subcategories')}}</a>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.All subcategories')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">{{trans('dashboard_trans.All subcategories')}}</span>
                    </h3>
                <div class="card-toolbar">
                    <a href="{{route('subcategories.create')}}" class="btn btn-sm btn-light-primary">
                        <!--begin::Svg Icon | path: icons/duotone/Communication/Add-user.svg-->
                        <span class="svg-icon svg-icon-2">
                            <i class="fa fa-plus"></i>
                        </span>
                        <!--end::Svg Icon-->  {{trans('dashboard_trans.Add new subcategories')}}</a>
                </div>
                </div>
                            ...
                            <table class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                ...
                                @foreach($subcategories as $key=>$subcategory)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('subcategories.edit' , $subcategory->id)}}" class="btn btn-sm btn-light-primary">
                                                <!--begin::Svg Icon | path: icons/duotone/Communication/Add-user.svg-->
                                            ...
                                            <a href="#"  onclick="confirmDelete (this, '{{ $subcategory->id }}')"
        ...
        function confirmDelete(app,id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        deleteSubcategory(app,id)
                    )
                }
            })
        }

        function deleteSubcategory(app, id) {
