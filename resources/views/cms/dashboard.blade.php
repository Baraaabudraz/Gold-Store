...
<path
    ...
    fill="#000000"/>
        ...
        <div class="col-xl-6">
            <!--begin::Statistics Widget 5-->
            <a href="{{route('categories.index')}}" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                <!--begin::Body-->
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-inverse-success fw-bolder fs-2 mb-2 mt-5">{{trans('dashboard_trans.Categories')}}</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
