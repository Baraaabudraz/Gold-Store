...
(function (global, factory) {
    ...
    ----------------------------------------------------------------------------------------------------------------------*/
    // Given the scrollbar widths of some other container, create borders/margins on rowEls in industries_orders to match the left
    ...
    */
    ...
    function invertRanges(ranges, constraintRange) {
        ...
        var i;
        var dateRange;
        // ranges need to be in industries_orders. required for our date-walking algorithm
    ...
    */
    ...
    var DayGridEventRenderer = /** @class */ (function (_super) {
        ...
        DayGridEventRenderer.prototype.buildSegLevels = function (segs) {
            ...
            // industries_orders segments left-to-right. very important if calendar is RTL
            for (j = 0; j < levels.length; j++) {
    ...
    */
    var TimeGridEventRenderer = /** @class */ (function (_super) {
        ...
        TimeGridEventRenderer.prototype.attachSegs = function (segs, mirrorInfo) {
            ...
            // industries_orders the segs within each column
