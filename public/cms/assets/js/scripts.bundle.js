...
(function($) {
	...
	$.fn[pluginName].defaults = {
		...
		// toolbar
		toolbar: {
			// place pagination and displayInfo blocks according to the array industries_orders
...
var KTLayout = function() {
	...
	var initAsideToggler = function() {
		...
		asideToggler.on('toggle', function(toggle) {
			...
			// the body tag in industries_orders to initialize the minimized left aside mode during page loading.
		});
